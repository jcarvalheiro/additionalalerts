...
class PluginAdditionalalertsEquipmentWarrantyAlert extends PluginAdditionalalertsAdditionalalert {
    /**
    ...
    public static function displayAlerts() {
        ...
        if (empty($expired)) {
            echo '<div class="center">'.__('No equipment with expired warranty', 'additionalalerts').'</div>';
            return;
        }
