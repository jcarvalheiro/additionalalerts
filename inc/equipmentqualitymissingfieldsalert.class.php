...
class PluginAdditionalalertsEquipmentQualityMissingFieldsAlert extends PluginAdditionalalertsAdditionalalert {
    /**
    ...
    public static function displayAlerts() {
        ...
        if (empty($list)) {
            echo '<div class="center">'.__('No equipment with missing or inconsistent required fields', 'additionalalerts').'</div>';
            return;
        }
