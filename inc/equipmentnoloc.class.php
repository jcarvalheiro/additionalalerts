...
/**
 * Class PluginAdditionalalertsEquipmentNoLoc
 */
class PluginAdditionalalertsEquipmentNoLoc extends CommonDBTM {

   static $rightname = "plugin_additionalalerts";

   static function getTypeName($nb = 0) {
      return _n('Equipment with no location', 'Equipments with no location', $nb, 'additionalalerts');
   }
   ...
   static function cronInfo($name) {
      switch ($name) {
         case 'AdditionalalertsEquipmentNoLoc':
            return [
               'description' => PluginAdditionalalertsEquipmentNoLoc::getTypeName(2)
            ];
            break;
      }
      return [];
   ...
   static function displayBody($data) {
      ...
      $body .= "<td>" . __('No location', 'additionalalerts') . "</td>";
      $body .= "<td>";
