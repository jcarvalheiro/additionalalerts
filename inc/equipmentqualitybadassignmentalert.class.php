...
class PluginAdditionalalertsEquipmentQualityBadAssignmentAlert extends PluginAdditionalalertsAdditionalalert {
    /**
    ...
    public static function displayAlerts() {
        ...
        if (empty($list)) {
            echo '<div class="center">'.__('No equipment assigned to disabled/nonexistent user or service', 'additionalalerts').'</div>';
            return;
        }
