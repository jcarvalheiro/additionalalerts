...
class PluginAdditionalalertsNotificationTargetTicketOpenTech extends NotificationTarget {

   static $rightname = "plugin_additionalalerts";

   function getEvents() {
      return ['ticketopentech' => PluginAdditionalalertsTicketOpenTech::getTypeName(2)];
   }
