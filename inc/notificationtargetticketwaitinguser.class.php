...
class PluginAdditionalalertsNotificationTargetTicketWaitingUser extends NotificationTarget {

   static $rightname = "plugin_additionalalerts";

   function getEvents() {
      return ['ticketwaitinguser' => PluginAdditionalalertsTicketWaitingUser::getTypeName(2)];
   }
