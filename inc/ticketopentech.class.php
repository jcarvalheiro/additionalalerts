...
/**
 * Class PluginAdditionalalertsTicketOpenTech
 */
class PluginAdditionalalertsTicketOpenTech extends CommonDBTM {

   static $rightname = "plugin_additionalalerts";

   static function getTypeName($nb = 0) {
      return _n('Technician with too many open tickets', 'Technicians with too many open tickets', $nb, 'additionalalerts');
   }
   ...
   static function cronInfo($name) {
      switch ($name) {
         case 'AdditionalalertsTicketOpenTech':
            return [
               'description' => PluginAdditionalalertsTicketOpenTech::getTypeName(2)
            ];
            break;
      }
      return [];
