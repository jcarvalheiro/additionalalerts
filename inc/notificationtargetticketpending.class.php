...
class PluginAdditionalalertsNotificationTargetTicketPending extends NotificationTarget {

   static $rightname = "plugin_additionalalerts";

   function getEvents() {
      return ['ticketpending' => PluginAdditionalalertsTicketPending::getTypeName(2)];
   }
