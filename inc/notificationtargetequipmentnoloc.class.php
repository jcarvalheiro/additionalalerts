...
class PluginAdditionalalertsNotificationTargetEquipmentNoLoc extends NotificationTarget {

   static $rightname = "plugin_additionalalerts";

   function getEvents() {
      return ['equipmentnoloc' => PluginAdditionalalertsEquipmentNoLoc::getTypeName(2)];
   }
