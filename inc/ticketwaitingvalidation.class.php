...
/**
 * Class PluginAdditionalalertsTicketWaitingValidation
 */
class PluginAdditionalalertsTicketWaitingValidation extends CommonDBTM {

   static $rightname = "plugin_additionalalerts";

   static function getTypeName($nb = 0) {
      return _n('Ticket waiting for validation', 'Tickets waiting for validation', $nb, 'additionalalerts');
   }
   ...
   static function cronInfo($name) {
      switch ($name) {
         case 'AdditionalalertsTicketWaitingValidation':
            return [
               'description' => PluginAdditionalalertsTicketWaitingValidation::getTypeName(2)
            ];
            break;
      }
      return [];
