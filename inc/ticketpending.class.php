...
/**
 * Class PluginAdditionalalertsTicketPending
 */
class PluginAdditionalalertsTicketPending extends CommonDBTM {

   static $rightname = "plugin_additionalalerts";

   static function getTypeName($nb = 0) {
      return _n('Ticket pending too long', 'Tickets pending too long', $nb, 'additionalalerts');
   }
   ...
   static function cronInfo($name) {
      switch ($name) {
         case 'AdditionalalertsTicketPending':
            return [
               'description' => PluginAdditionalalertsTicketPending::getTypeName(2)
            ];
            break;
      }
      return [];
