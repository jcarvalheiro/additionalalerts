...
class PluginAdditionalalertsNotificationTargetTicketHighPriority extends NotificationTarget {

   static $rightname = "plugin_additionalalerts";

   function getEvents() {
      return ['tickethighpriority' => PluginAdditionalalertsTicketHighPriority::getTypeName(2)];
   }
