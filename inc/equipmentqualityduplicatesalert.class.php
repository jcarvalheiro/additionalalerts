...
class PluginAdditionalalertsEquipmentQualityDuplicatesAlert extends PluginAdditionalalertsAdditionalalert {
    /**
    ...
    public static function displayAlerts() {
        ...
        if (empty($list)) {
            echo '<div class="center">'.__('No equipment with detected duplicates', 'additionalalerts').'</div>';
            return;
        }
